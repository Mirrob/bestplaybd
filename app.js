...
// EXTRA_BN_CLEANUP_2026: text-only Bangla cleanup for static and JS-rendered labels.
COMMON_TRANSLATIONS.push(
  ["BD Bonus Compare", "BD বোনাস তুলনা"],
  ["Best Sites BD", "সেরা সাইট BD"],
  ["Best Sites BD 2026", "সেরা সাইট BD ২০২৬"],
  ["/ Best Sites BD", "/ সেরা সাইট BD"],
  ["/ Reviews", "/ রিভিউ"],
  ...
  ["/ Deposit Guide", "/ ডিপোজিট গাইড"],
  ["/ BanglaWin Review", "/ BanglaWin রিভিউ"],
  ["Top Brands", "টপ ব্র্যান্ড"],
  ["SEO Guide", "গাইড"],
  ["SEO GUIDE", "গাইড"],
  ["Steps", "ধাপ"],
  ["STEPS", "ধাপ"],
  ["Live Promos", "লাইভ প্রোমোশন"],
  ["LIVE PROMOS", "লাইভ প্রোমোশন"],
  ["Promos", "প্রোমোশন"],
  ["Promotions", "প্রোমোশন"],
  ["Reviews", "রিভিউ"],
  ...
  ["MCW Review", "MCW রিভিউ"],
  ["BanglaWin Review", "BanglaWin রিভিউ"],
  ["Compare All Brands", "সব ব্র্যান্ড তুলনা করুন"],
  ["All Promos", "সব প্রোমোশন"],
  ["Deposit Guide", "ডিপোজিট গাইড"],
  ["Games", "গেমস"],
  ["Ranking", "র‍্যাঙ্কিং"],
  ["Navigate", "নেভিগেশন"],
  ...
  ["Brand Limits", "ব্র্যান্ড লিমিট"],
  ["Top 5 Compare", "টপ ৫ তুলনা"],
  ["Top 5 Comparison Table", "টপ ৫ তুলনা টেবিল"],
  ["Brand", "ব্র্যান্ড"],
  ["Min Deposit", "ন্যূনতম ডিপোজিট"],
  ["Minimum deposit", "ন্যূনতম ডিপোজিট"],
  ["Withdraw", "উত্তোলন"],
  ...
  ["Pros", "ভালো দিক"],
  ["Check", "আগে দেখুন"],
  ["Check First", "আগে দেখুন"],
  ["Sports + Casino", "স্পোর্টস + ক্যাসিনো"],
  ["Slots Casino + Higher Promos", "স্লট ক্যাসিনো + বেশি প্রমোশন"],
  ["Slots + Higher Promos", "স্লট + বেশি প্রমোশন"],
  ["Slots + Casino + Deshi vibes", "স্লট + ক্যাসিনো + দেশি অভিজ্ঞতা"],
  ["Slots + Casino + Beginner friendly", "স্লট + ক্যাসিনো + নতুনদের জন্য সহজ"],
  ["Slots + Casino", "স্লট + ক্যাসিনো"],
  ["Slots + Promos", "স্লট + প্রমোশন"],
  ["Slots + Deshi", "স্লট + দেশি অভিজ্ঞতা"],
  ["Beginner Friendly", "নতুনদের জন্য সহজ"],
  ["Beginner friendly", "নতুনদের জন্য সহজ"],
  ["Strong sports + casino", "স্পোর্টস ও ক্যাসিনোতে শক্তিশালী"],
  ["24/7 withdrawal support", "২৪/৭ উত্তোলন সুবিধা"],
  ["Wide BD payments", "বাংলাদেশি পেমেন্ট সুবিধা বিস্তৃত"],
  ["Promo terms can change", "প্রমোশনের নিয়ম বদলাতে পারে"],
  ["Slots casino focus", "স্লট ক্যাসিনোতে ফোকাস"],
  ["Higher promo positioning", "বেশি প্রমোশনের জন্য ভালো"],
  ["Turnover rules", "টার্নওভারের নিয়ম"],
  ["Eligible games", "যোগ্য গেম"],
  ["Sports focused", "স্পোর্টস-কেন্দ্রিক"],
  ["Cricket/football friendly", "ক্রিকেট/ফুটবল ব্যবহারকারীদের জন্য ভালো"],
  ["Simple payment flow", "সহজ পেমেন্ট প্রক্রিয়া"],
  ["Odds rules", "অডসের নিয়ম"],
  ["Promo expiry", "প্রমোশনের মেয়াদ"],
  ["Deshi vibe", "দেশি অভিজ্ঞতা"],
  ["Cashback-style promo fit", "ক্যাশব্যাক ধরনের প্রমোশনের জন্য ভালো"],
  ["Valid games", "যোগ্য গেম"],
  ["Campaign availability", "ক্যাম্পেইন চালু আছে কি না"],
  ["Easy start", "সহজে শুরু করা যায়"],
  ["Good for new users", "নতুন ব্যবহারকারীদের জন্য ভালো"],
  ["Bonus rules", "বোনাসের নিয়ম"],
  ["Withdrawal notes", "উত্তোলন নোট"],
  ["Quick Scores", "দ্রুত স্কোর"],
  ["Quick Score", "দ্রুত স্কোর"],
  ["Quick Action", "দ্রুত এগিয়ে যান"],
  ["Call to Action", "পরবর্তী ধাপ"],
  ["Promo Details", "প্রমোর বিস্তারিত"],
  ["Updated recently", "সাম্প্রতিক আপডেট"],
  ["Turnover / wagering", "টার্নওভার / ওয়েজারিং"],
  ["Expiry date", "মেয়াদ শেষের তারিখ"],
  ["Mobile usability", "মোবাইলে ব্যবহার সহজ"],
  ["Bonus clarity", "বোনাসের নিয়ম পরিষ্কার"],
        ...
        <div class="container detail-layout">
          <div class="detail-stack">
            ...
            <div class="content-shell">
              ...
              <div class="info-list">
                <div class="link-pill"><strong>${lang === "bn" ? "স্ট্যাটাস" : "Status"}</strong><span>${lang === "bn" ? "সাম্প্রতিক আপডেট" : promo.updated}</span></div>
